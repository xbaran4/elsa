_build_hub:
	...
	podman build . -t docker.io/astronomycommons/adass-jupyterhub:tag

_build_notebook:
	cd images/notebook && \
	export BUILDAH_FORMAT=docker && \
	podman build . -t docker.io/astronomycommons/adass-notebook:tag

build: _build_hub _build_notebook

_push_hub:
	podman push docker.io/astronomycommons/adass-jupyterhub:tag

_push_notebook:
	podman push docker.io/astronomycommons/adass-notebook:tag
...
_start_jupyterhub:
	...
	podman run --rm -it \
		...
		docker.io/astronomycommons/adass-jupyterhub:tag
...
_start_notebook:
	...
	podman run --rm -it \
		...
		docker.io/astronomycommons/adass-notebook:tag
